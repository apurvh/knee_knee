...
//              ),
                  ...
                  Text(
                    "Max Value: ${maxValueAngle - minValueAngle}",
                    style: TextStyle(
                        fontSize: 15.0,
...
//      parsedDataList.add(parsedData);
      ...
      if (maxValueAngle < parsedData) maxValueAngle = parsedData;
      if (minValueAngle < parsedData) minValueAngle = parsedData;

//    print(double.parse(getWData[i].toString()));
    }
    return [
      new charts.Series<LinearSales, int>(
        id: 'Sales',
